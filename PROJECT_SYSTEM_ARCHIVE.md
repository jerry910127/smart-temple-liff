...
* **四大核心服務入口 (Quick Access Grid: $Y \approx 32\% \sim 45\%$)**：
  * `湄洲媽靈籤`（串 Web 抽籤擲筊）、`祈安點燈`（萬春宮光明燈、文昌燈、太歲燈與五大凶星祭解）、`三百年巡禮`（**點擊直通頁面二**）、`法會科儀`（萬春宮行事曆與白米收驚）
...
* **萬春宮道法特色專區 (Zodiac Evil Star Banner: $Y \approx 83\% \sim 92\%$)**：
  * 【生肖歲煞】五大凶星 AI 祭解排盤（五鬼、天狗、白虎、刑剋、空亡・即時測算本命歲煞與開基三媽開示，支援線上登記消災疏文）
* **底部導航欄 (Bottom Dock: $Y \approx 92\% \sim 100\%$)**：首頁、線上求籤、奉茶優惠、信士中心
